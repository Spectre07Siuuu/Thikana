        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 animate-fade-in">
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm p-7">
            ...
            <ProseSection title="8. Your Rights">
              You have the right to access, correct, or delete your personal data. Contact us at <a href="mailto:support@thikana.com" className="text-orange-500">support@thikana.com</a> to exercise these rights.
            </ProseSection>

            <ProseSection title="9. Contact">
              For privacy concerns, contact us at <a href="mailto:support@thikana.com" className="text-orange-500">support@thikana.com</a>.
            </ProseSection>
          </div>
...
function ProseSection({ title, children }) {
  return (
    <div className="mb-6">
      ...
      <div className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed space-y-2 [&_ul]:pl-4 [&_ul]:list-disc [&_ul]:space-y-1">{children}</div>
    </div>
  )
}
