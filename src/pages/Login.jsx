...
export default function Login() {
 ...
 return (
  <div className="min-h-screen flex items-center justify-center
   bg-theme-bg px-4 py-8 transition-colors duration-200">
   <div className="w-full max-w-md animate-slide-up">
    ...
    <div className="text-center mb-6">
     ...
     <h1 className="text-2xl font-black text-theme-text">Welcome back</h1>
     ...
     <form id="login-form" onSubmit={handleSubmit} noValidate className="space-y-3.5">
      ...
      <div>
       <div className="flex items-center justify-between mb-1.5">
        ...
        <Link to="/forgot-password" className="text-xs text-theme-primary hover:text-theme-primary-hover font-medium">
         Forgot password?
        </Link>
       </div>
       <div className="relative">
    ...
    <p className="text-center text-sm text-theme-muted mt-5">
     ...
     <Link to="/signup" className="text-theme-primary hover:text-theme-primary-hover font-semibold">
      Sign up free
     </Link>
    </p>
