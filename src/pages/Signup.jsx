  ...
  return (
   <div className="min-h-screen flex items-center justify-center bg-theme-bg">
    <div className="text-center animate-slide-up">
     ...
     <h2 className="text-2xl font-bold text-theme-text mb-2">Account Created!</h2>
  ...
  <div className="min-h-screen bg-theme-bg transition-colors duration-200">
   <div className="max-w-md mx-auto px-4 py-8">
    ...
    <div className="text-center mb-5">
     ...
     <h1 className="text-2xl font-black text-theme-text">Create account</h1>
     <p className="text-theme-muted text-sm mt-1">Start your journey — completely free.</p>
    </div>
     ...
     <form id="signup-form" onSubmit={handleSubmit} noValidate className="space-y-3.5">
      ...
      <Field label="Full Name" error={errors.fullName}>
       <div className="relative">
        <User size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-theme-muted pointer-events-none" />
      ...
      <Field label="Email" error={errors.email}>
       <div className="relative">
        <Mail size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-theme-muted pointer-events-none" />
      ...
      <Field label="I am a…" error={errors.role}>
       <div className="relative">
        ...
        <ChevronDown size={15} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-theme-muted pointer-events-none" />
       </div>
      </Field>
      ...
      <Field label="Password" error={errors.password}>
       <div className="relative">
        <Lock size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-theme-muted pointer-events-none" />
        ...
        <button type="button" onClick={() => setShowPassword(v => !v)}
         className="absolute right-3.5 top-1/2 -translate-y-1/2 text-theme-muted
      ...
      <div>
       <label className="flex items-start gap-3 cursor-pointer">
        ...
        <span className="text-xs text-theme-muted leading-relaxed">
         ...
         <Link to="/terms" className="text-theme-primary hover:underline">Terms</Link>
         {' '}and{' '}
    ...
    <p className="text-center text-sm text-theme-muted mt-4">
     ...
     <Link to="/login" className="text-theme-primary hover:text-theme-primary-hover font-semibold">Sign in</Link>
    </p>
    <p className="text-center text-theme-muted text-xs mt-3 flex items-center justify-center gap-1.5">
